    ...
    scaleAnimation.addListener(() {
      ...
      if (scaleAnimation.value == 1.0) {
        ...
        if (widget.onPositionUpdate != null) {
          widget.onPositionUpdate!(Offset((auxLeft + localLeft + centerLeft + scaleLeft) * -1, (auxTop + localTop + centerTop + scaleTop) * -1));
        }
                ...
                children: <Widget>[
                  Positioned(
                    ...
                    child: Transform.scale(
                      ...
                      child: Container(
                        decoration: BoxDecoration(color: widget.canvasColor, boxShadow: widget.canvasShadow != null ? [widget.canvasShadow!] : null),
